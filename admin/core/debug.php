...
{
    $dump_indent = "<span style='color:#666666;'>|</span> &nbsp;&nbsp; ";
    $reference = $reference.$var_name;
    $keyvar = 'the_dump_recursion_protection_scheme'; $keyname = 'referenced_object_name';
    ...
    else
    {
        ...
        if(is_array($avar))
        {
            ...
            {
                $value = &$avar[$name];
                dump($value, "['$name']", $indent.$dump_indent, $reference);
            }
            echo "$indent)<br>";
        }
        elseif(is_object($avar))
        {
            ...
            foreach($avar as $name=>$value) dump($value, "$name", $indent.$dump_indent, $reference);
            echo "$indent)<br>";
        }
