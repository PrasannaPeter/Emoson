        ...
        <ul class="user-info pull-left pull-none-xsm">
            ...
            <li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a href="neon/mailbox/main/index.html">
                    ...
                    <li>
                        <a href="neon/extra/calendar/index.html">
...
<li class="external">
    <a href="neon/mailbox/main/index.html">All Messages</a>
</li>               </ul>
            ...
            <li class="notifications dropdown">
                ...
                <ul class="dropdown-menu">
                    <li class="top">
    <p>Vous avez 6 projets en cours</p>
</li>
