  ...
  <div class="col-md-12">
    <div class="panel panel-default panel-dark">
        ...
        <div class="panel-heading">
            <div class="panel-title">Gestion des projets</div>
        ...
        <div class="panel-body">
            <div>
                    <p>Vous êtes actuellement dans la gestion des projets.</p>
                    <p>Vous pouvez effectuer des actions relatives aux projets en cliquant sur un des boutons suivants.</p>
            </div>

            <a href="?module=projet&action=manage&type=ajouter"><button type="button" class="btn btn-primary">
                <i class="entypo-plus"></i>Ajouter</button></a>
