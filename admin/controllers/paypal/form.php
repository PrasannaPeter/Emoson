...
<div class="as_wrapper">
    ...
    <form action="index.php?module=paypal&action=paypal.php?sandbox=1" method="post"> <?php // remove sandbox=1 for live transactions ?>
    ...
    <tr>
        <td colspan="2" align="center"><button class="btn btn-primary" type="submit" name="submit" value="ok">Confirmer</button></td>
    </tr>
    </table>
    <br>
    </form>
