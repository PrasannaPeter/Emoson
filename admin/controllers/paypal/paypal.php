...
define('EMAIL_ADD', 'giraud.valentin@gmail.com'); // define any notification email
define('PAYPAL_EMAIL_ADD', 'giraud.valentin-facilitator@gmail.com'); // facilitator email which will receive payments change this email to a live paypal account id when the site goes live
