...
<div id="content">
  ...
  <div class="inner">
    ...
    <center>
    <a class="btn btn-large btn-info" href="index.php?module=projet&action=voir_page_projet&idProjet=<?php echo $get_projet['idProjet']; ?>" role="button"><i class="fa fa-file-text"></i> <span>Page du projet</span></a>
