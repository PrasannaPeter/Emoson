         ...
         <section class="row-fluid">
          <section class="span12 storyblock">
            ...
            <div class="block-content butt-flexslider">
              <ul class="slides">
                <li class="user-avatar"> <a href="#"><img src="style/content/users-avatar/user-1.jpg" alt="User" height="114" width="114"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-2.jpg" alt="User" height="114" width="113"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-3.jpg" alt="User" height="114" width="114"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-4.jpg" alt="User" height="114" width="113"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-5.jpg" alt="User" height="114" width="114"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-2.jpg" alt="User" height="114" width="113"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-3.jpg" alt="User" height="114" width="114"/>
                ...
                <li class="user-avatar"> <a href="#"><img src="style/content/users-avatar/user-5.jpg" alt="User" height="114" width="114"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-4.jpg" alt="User" height="114" width="113"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-3.jpg" alt="User" height="114" width="114"/>
                  ...
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-1.jpg" alt="User" height="114" width="114"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-2.jpg" alt="User" height="114" width="113"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-3.jpg" alt="User" height="114" width="114"/>
                ...
                <li class="user-avatar"> <a href="#"><img src="style/content/users-avatar/user-3.jpg" alt="User" height="114" width="114"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-2.jpg" alt="User" height="114" width="113"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-5.jpg" alt="User" height="114" width="114"/>
                ...
                <li class="user-avatar"> <a href="#"> <img src="style/content/users-avatar/user-1.jpg" alt="User" height="114" width="114"/>
                  ...
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-2.jpg" alt="User" height="114" width="114"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-5.jpg" alt="User" height="114" width="113"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-3.jpg" alt="User" height="114" width="114"/>
                  <div class="effect"></div>
                  </a> <a href="#"><img src="style/content/users-avatar/user-2.jpg" alt="User" height="114" width="113"/>
...
<!--               <div class="right">
            ...
            <div id="fol-menu" class="footer-menu">
              ...
              <ul>
                <li><a href="#">Blog</a></li>
                <li><a href="https://twitter.com/EmoSonAgency">Twitter</a></li>
                <li><a href="https://www.facebook.com/EmoSonAgency?ref=br_tf">Facebook</a></li>
                <li><a href="https://www.youtube.com/user/EmoSonAgency">Youtube</a></li>
              </ul>
            </div>
      ...
      <div id="copyright-link">
        <div class="buttons">
          <ul class="top_soical_icons pull-right	">
            <li> <a href="https://www.facebook.com/EmoSonAgency?ref=br_tf"> <i class="fa fa-facebook"></i> </a> </li>
            <li> <a href="#"> <i class="fa fa-google-plus"></i> </a> </li>
            <li> <a href="https://twitter.com/EmoSonAgency"> <i class="fa fa-twitter"></i> </a> </li>
